...
🎓 **BCA Student** | 🤖 **AI/ML Enthusiast** | 📊 **Data Science Explorer**  
...
> *"Learning happens when you build things that matter"*

**Check out my repositories** to see:
- 🎯 Real-world ML projects deployed & live
- 📈 Data science explorations & analysis
- 🐍 Python fundamentals to advanced concepts
- 💡 Problem-solving approaches & implementations
